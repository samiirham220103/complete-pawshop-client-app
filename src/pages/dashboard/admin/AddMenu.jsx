          ...
          <div className="flex items-center gap-4">
            ...
            <div className="form-control w-full my-6">
              ...
              >
                ...
                <option value="salad">Makanan</option>
                <option value="pizza">Mainan</option>
                <option value="soup">Obat & Vitamin</option>
                <option value="dessert">Alat Kebersihan</option>
                <option value="drinks">Tas Ransel</option>
